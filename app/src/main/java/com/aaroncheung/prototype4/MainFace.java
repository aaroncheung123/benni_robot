...
public class MainFace extends AppCompatActivity implements
        RecognitionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        happyface = (ImageView) findViewById(R.id.happyface1);
        ...
        switch (requestCode) {
            case REQUEST_RECORD_PERMISSION:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(MainFace.this, "Permission Denied!", Toast
                            .LENGTH_SHORT).show();
                }
        }
    }
